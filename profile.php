...
$lockvalue = 'fa fa-lock';
 }
 else {
$membershipstatus = 'VALID';
$lockvalue = 'fa fa-unlock-alt';
 } 
...
$affiliatelink = '__'.base64_encode($uniqueidentifierperson);
...
if ($emailCounter <= 1 ) { 
 ...
 echo '									
										...
										<span class="home-list-pop-rat"><i class="'.$lockvalue.'" style="font-size:25px;color:#337ab7" aria-hidden="true"></i></span>
  ...
  if (!App::Auth()->is_User()) {
echo '												<li style="width:40% !important;"><a href="build-report.php?unique='.$affiliatelink.'"><i class="fa fa-search" aria-hidden="true"></i>View Full Profile</a> </li>'
  ;}
   echo '
											</ul>
...
<div class="col-md-12">
						...
						echo '<tr>';
						echo '<td><span class="txt-dark weight-500"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></span></td>';
						echo '<td><span class="txt-dark weight-500"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></span></td>';
						echo '<td><span class="txt-dark weight-500"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></span></td>';
						echo '</tr>';
						}
...
$test = 0;
	...
	if ($membershipstatus == "VALID") {
					...
					echo '</tr>';
						...
						echo '<tr>';
					echo '<td><span class="txt-dark weight-500" style="font-weight:bold;"><a href="build-report.php?unique='.$affiliatelink.'">'. "View Full Profile ->" .'</a></span>';
					echo '<li><a href="build-report.php?unique='.$affiliatelink.'">'."View Full Profile ->".'</a></li></td>';
					echo '<td><span class="txt-dark weight-500"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></span></td>';
                  ...
                  <tbody>
					...
					$test = 0;
						...
						echo '</tr>';
							...
							echo '<tr>';
						echo '<td class="col3"><span itemprop="alumniOf"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></span></td>';
						echo '<td class="col3"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></td>';
						echo '<td class="col4"><a href="build-report.php?unique='.$affiliatelink.'">' . "View Full Profile ->" . '</a></td>';
						echo '</tr>';
						}
						}
						if ($membershipstatus == "VALID") {
               ...
               <tr>
  				<?php if ($membershipstatus == "VALID") {
					...
					<?php if ($membershipstatus == "INVALID") {	
								echo '
                    <td class="col2"><a href="build-report.php?unique='.$affiliatelink.'">View Full Profile -></a></td>';
					}
					?>
  ...
  <!-- Related ends here --> 
     ...
     <div class="col-md-12" id="arrest">
               ...
               <tr>
  					<?php if ($membershipstatus == "VALID") {
									echo '
                    <td class="col2">No Sex Offender Records Found</td>';
					}
					?>
					<?php if ($membershipstatus == "INVALID") {	
								echo '
  ...
  <!-- Related ends here --> 
            ...
            <div class="col-md-12" id="vehicle">
               ...
               <tr>
  					<?php if ($membershipstatus == "VALID") {
									echo '
                    <td class="col2">No Vehicle Records Found</td>';
					}
					?>
					<?php if ($membershipstatus == "INVALID") {	
								echo '
