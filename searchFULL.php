...
if (isset($st) && strlen($st) == 2) {
$searchquery = "SELECT id, ADDR FROM `datanew` WHERE `FN` = '$first' AND `LN` = '$last' AND `ST` = '$st' LIMIT 500"; }
else {
$searchquery = "SELECT id, ADDR FROM `datanew` WHERE `FN` = '$first' AND `LN` = '$last'  LIMIT 500"; }
...
if (isset($st) && strlen($st) == 2) {
$searchquery = "SELECT id, ADDR FROM `data` WHERE `FN` = '$first' AND `LN` = '$last' AND `ST` = '$st' LIMIT 500"; }
else {
$searchquery = "SELECT id, ADDR FROM `data` WHERE `FN` = '$first' AND `LN` = '$last'  LIMIT 500"; }
...
if (isset($st) && strlen($st) == 2) {
$searchquery = "select distinct(c.uniqueId)
    from basic c
	inner join address o
            on c.uniqueId = o.uniqueId
    where c.firstName = '$first' and c.lastName = '$last' and o.state = '$st' LIMIT 500"; }
	
else {
$searchquery = "SELECT uniqueId FROM `basic` WHERE `firstName` = '$first' AND `lastName` = '$last' LIMIT 500"; }
    ...
    echo '	  <div class="pglist-p-com-ti">
								...
								<div class="list-pg-write-rev">
									...
									<form name="frm" method="POST" action="" class="col">
										...
										<p>Do you feel like we are missing a record for <strong>' . strtoupper($first) . ' ' . strtoupper($last) . '? Not a problem, give us your details and we will shoot over an email as soon as we find the result you are looking for:</p>
...
$uniqueId = '__'.$uniqueId.'&d=e&t='.$experianDbType;
	 ...
	 $fullAddressNew = $street.', '.$city.', '.$state;
	  $fullAddressNew = strtolower($fullAddressNew);
	  $fullAddressNew = ucwords($fullAddressNew);
	 $fullname = $firstname.' '.$middleName.' '.$lastName;
...
$addressCounterExperian = '1';
	if ($addressCounterExperian <= 1 ) { 
	echo '<a href="eprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Search for more </li></a> <br/>'; }
	else {
	 echo '<a href="eprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($addressCounterExperian - 1).' more </li></a> <br/>'; }
    echo '</p>
	</div>
...
<div class="col-md-6 home-list-pop-desc inn-list-pop-desc" style="float:left;">
    ...
    for ($o = 0; $o < 1; $o++) {
	  // echo $addressCounter << die execute reg, soveel keer vir soveel addresse.
				...
				$relativeFullName = $relativeFirstName.' '.$relativeMiddleName.' '.$relativeLastName;
				$relativeFullName = strtolower($relativeFullName);
				$relativeFullName = ucwords($relativeFullName);
	  echo '<li>'.$relativeFullName.'</li> ';
    }
	$relativesCounterExperian = '1';
	if ($relativesCounterExperian <= 1 ) { 
	echo '<a href="eprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Search for more </li></a> <br/>'; }
	else {
	 echo '<a href="eprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($relativesCounterExperian - 1).' more </li></a> <br/>'; }
    echo '</p>
...
if ($phoneCounter <= 2 ) { 
	echo '<a href="eprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Build Report! </li></a> <br/>'; }
	else {
 ...
 echo '									
										...
										<div class="list-enqu-btn">
											...
											<ul>
												...
												<li><a href="eprofile.php?unique='.$uniqueId.'"><i class="fa fa-search" aria-hidden="true"></i> Free Profile</a> </li>
...
<div class="col-md-6 home-list-pop-desc inn-list-pop-desc" style="float:left;">
	...
	if ($addressCounter <= 1 ) { 
	echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Search for more </li></a> <br/>'; }
	else {
	 echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($addressCounter - 1).' more </li></a> <br/>'; }
    echo '</p>
	</div>
...
<div class="col-md-6 home-list-pop-desc inn-list-pop-desc" style="float:left;">
	...
	echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Search for more </li></a> <br/>'; }
	 ...
	 echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($relativesCounter - 1).' more </li></a> <br/>'; }
    echo '</p>
...
if ($phoneCounter <= 1 ) { 
	echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Build Report! </li></a> <br/>'; }
	else {
	 echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($phoneCounter - 1).' more </li></a> <br/>'; }
...
if ($emailCounter <= 1 ) { 
	echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">Build Report! </li></a> <br/>'; }
	 ...
	 echo '<a href="sprofile.php?unique='.$uniqueId.'" style="color:#337ab7 !important;"><li style="color:#337ab7 !important;">and atleast '.($emailCounter - 1).' more </li></a> <br/>'; } 
 echo '									
										...
										<div class="list-enqu-btn">
											...
											<ul>
												...
												<li><a href="sprofile.php?unique='.$uniqueId.'"><i class="fa fa-search" aria-hidden="true"></i> Free Profile</a> </li>
