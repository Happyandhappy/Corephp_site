! function(t) {
    ...
    (function(t) {
        ...
        var url = "http://speedyhunt.com/dashboard/view/front/controller.php"; // the script where you handle the form input.

    $.ajax({
           type: "POST",
           url: url,
           data: $("#signup-modal-form").serialize(), // serializes the form's elements.
