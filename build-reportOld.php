...
<head>
    ...
    <title>Building BeenVerified Report</title>
                                                            ...
                                                            <div id="card-misc" class="card-single">
                                                                ...
                                                                <div class="visible-xs hidden-xxs">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <p class="text-left">You'll get access to BeenVerified's <strong>proprietary Monitoring feature</strong>, which sends alerts and monitors potential changes we find in our data on an ongoing basis.
                                                                            </p>
                                                                        </li>
                                                                    </ul>
                                                                    <div class="clearfix"></div>
                                                                ...
                                                                <div class="hidden-xs">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <p>You'll get access to BeenVerified's <strong>proprietary Monitoring feature</strong>, which sends alerts and monitors potential changes we find in our data on an ongoing basis.
                                                                            </p>
                                                                        </li>
                                                                        <li>
                                                                            <p>No more having to stay on top of the data yourself - <strong>let BeenVerified assist you.</strong></p>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
