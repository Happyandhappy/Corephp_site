...
#gatedata > td:nth-child(2) > div > div > a {
	font-weight:bold;
	margin-left:5px;
	cursor:pointer;
}
...
table.wojo.basic.unstackable.table {
	width:100%;
}
    ...
    <div id="main">
        <div class="cv2-message">
            <div class="wrapper cf">
                <h2>FINAL STEP: Activate Account to View Full Reports on <span>Unlimited Profiles</span></h2>
            </div>
        </div>
                                    ...
                                    <div class="cv2-sum">
                                        ...
                                        <div class="cv2-sum-info">
                                            <ul>
                                                ...
                                                <li>Name: <span>Unlimited Profiles</span>
                                                </li>
                                                <li>Subscription type: <span>Monthly</span>
                                                </li>
                    ...
                    <div class="cv2-half right">
                        <div class="cv2-block special">
                            <div class="cv2-block2 cv2-desktop">
                                ...
                                <div class="cv2-total">
                                    <div class="row">
                                        <div class="cell">Detailed Report on <span>Unlimited Profiles</span>
                                        </div>
                                ...
                                <div class="cv2-total">
                                    <div class="row total">
                                        ...
                                        <div class="cell">Today's Total: <i>Only $22.87</i>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id="login-wrap">
  <div class="login-form">
                                ...
                                <div class="cv2-form">
                                    ...
                                    <a class="wojo small button add-cart waves-effect waves-light btn-large full-btn waves-input-wrapper" data-id="1" name="clickform" id="clickform">Checkout</a>
                                          <div id="mResult"></div>
                                        </div>
                                    </div>
                    ...
                    <div class="cv2-half right">
                       ...
                       <!--  <img src="http://speedyhunt.com/dashboard/gateways/paypal/logo_large.png" width="110px" style="float:left;">-->
...
<script type="text/javascript"> 
 $(document).ready(function(){
            ...
            $.post("http://speedyhunt.com/dashboard/view/front/controller.php", {
