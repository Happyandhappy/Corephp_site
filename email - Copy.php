...
$searchquery = "SELECT distinct(dbIdentifier), db_type FROM `emailsUnique` WHERE `email` = '$emailSearch' and `db_type` != 'experian_data' and `db_type` != 'experian_newdata' LIMIT 500";
...
$searchquery = "SELECT distinct(dbIdentifier), db_type FROM `emailsUnique` WHERE `email` = '$emailSearch' and `db_type` != 'main_db' and `db_type` != 'quanki_hostgator' and `db_type` != 'quanki_newdata'  LIMIT 500";
$result  = $db1->query($searchquery);
...
<head>
	...
	<title><?php echo 'Results For '. ucwords($emailSearch);?></title>
			...
			<div class="row">
				...
				<div class="dir-alp-tit">
					...
					<ol class="breadcrumb">
						...
						<li><a href="email.php?email=<?php echo $emailSearch;?>"</a> </li>

						<li class="active" style="color:#fff;"><?php echo strtoupper($emailSearch); ?></li>
    ...
    echo '	  <div class="pglist-p-com-ti">
								...
								<div class="list-pg-write-rev">
									...
									<form name="frm" method="POST" action="" class="col">
										...
										<p>Do you feel like we are missing an email record for <strong>' . strtoupper($emailSearch) . '? Not a problem, give us your details and we will shoot over an email as soon as we find the result you are looking for:</p>
										...
										<div class="row">
<div class="input-field col s12"><input type="submit" name="Update" id="update" value="Find me details about ' . $emailSearch .'" class="waves-effect waves-light btn-large full-btn" /></div>
...
?>							
  ...
  var comments = $("#comments").val();
	 var query = '<?php echo $emailSearch; ?>';
   var type = 'email'; 
