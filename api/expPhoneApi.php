...
$phone = htmlentities(clean($_GET['ph']));

if ($phone == '' || $phone == NULL) {
header('Location: 404.php');
}

$searchquery = "SELECT id, ADDR FROM `datanew` WHERE `PHONE` = '$phone' LIMIT 500"; 
...
$searchquery = "SELECT id, ADDR FROM `data` WHERE `PHONE` = '$phone' LIMIT 500"; 
