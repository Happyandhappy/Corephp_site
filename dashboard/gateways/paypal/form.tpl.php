...
<input type="image" src="<?php echo SITEURL;?>/gateways/paypal/logo_large.png" style="width:250px; height:250px; cursor:pointer;" name="submit" class="wojo basic primary button" title="Pay With Paypal" alt="" onclick="document.pp_form.submit();">
  ...
  <input type="hidden" name="return" value="http://speedyhunt.com/Account.php">

  <input type="hidden" name="rm" value="2">

  <input type="hidden" name="notify_url" value="<?php echo SITEURL . '/gateways/'. $this->gateway->dir;?>/ipn.php">

  <input type="hidden" name="cancel_return" value="http://speedyhunt.com/membership.php">
