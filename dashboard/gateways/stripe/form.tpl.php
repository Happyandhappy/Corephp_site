  ...
  <div class="wojo fields">
    ...
    <div class="wojo fields">
     ...
     <div class="content-center">
      ...
      <button class="wojo small button add-cart waves-effect waves-light btn-large full-btn waves-input-wrapper" id="dostripe" name="dostripe" type="button"><?php echo Lang::$word->SUBMITP;?></button>
                ...
                if (json.type == "success") {
                    ...
                    $('.wojo-grid').velocity("transition.whirlOut", {
                        ...
                        complete: function() {
                            ...
                            window.location.href = 'https://speedyhunt.com/Account.php';
