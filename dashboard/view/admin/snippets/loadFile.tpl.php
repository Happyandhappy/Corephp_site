...
?>
  <div class="column" id="item_<?php echo $this->row->id;?>">
    <div class="wDimmer blurring dimmable">
      ...
      <div class="wojo files" style="background-color:<?php echo Content::fileStyle($this->row->type);?>"> <span class="size"><?php echo File::getSize($this->row->filesize);?></span>
        <div class="content"><?php echo Content::fileIcon($this->row->type);?></div>
