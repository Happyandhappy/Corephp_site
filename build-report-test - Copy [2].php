...
<body class="hide" data-next-page="/lp/a19763/5/subscribe">
    ...
    <div id="main-container">
        <div id="sub-container">
            <div class="headline hidden-xs" data-fr-bind="currentRecord searchData">Building Report: <?php echo $fullname; ?></div>
                                                        ...
                                                        <div class="col-sm-8 left-column">
                                                            <div class="lead-part">
                                                                <div class="" data-fr-bind="extraTeaserData currentRecord searchData">
                                                                    ...
                                                                    <form id="signup-modal-form" action="POST" data-fr-bind="leadData" data-fr-store="leadData">
                                                                    ...
                                                                    <fieldset class="form-input-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                <input name="fname" value="" id="lead_first_name" type="text" class="form-control" placeholder="First Name" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-3 hidden-xs hidden-sm">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                <input name="lname" value="" id="lead_last_name" type="text" class="form-control" placeholder="Last Name" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-3 hidden-xs hidden-sm">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                <input name="email" value="" id="lead_email" type="email" class="form-control" placeholder="Email Address" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-sm-3 hidden-xs hidden-sm">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                <input type="password" value="" id="password" type="password" class="form-control" placeholder="Password" name="password" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                <input type="captcha" value="" id="captcha" type="captcha" class="form-control" placeholder="captcha" name="captcha" required>
               <div class="wojo basic label"><img src="https://speedyhunt.com/dashboard/captcha.php" alt="" style="height:25px">
                                                                            </div>
                                                                        </div>
                                                                        </div>
                        ...
                        <button type="submit" class="main-btn main-btn-large btn-block" data-action="register" id="registerform" type="submit"><span class="hidden-xs"> BOTH &amp; </span>Continue</button>                                                 
                                    ...
                                    <section id="gen-report-modal4" class="" aria-hidden="true">
                                        <div class="content">
                                            <div class="captHeadContent col-sm-12">
                                                ...
                                                <p data-fr-bind="currentRecord searchData">Ongoing Notifications About <?php echo $fullname; ?></p>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-sm-12">
                ...
                <div class="modal-body clearfix">
                    <div class="searching-progress-bar-group col-xs-12">
                        <div id="chck-loading" class="progress checking-sources-progress hidden">
                            <div class="progress-bar progress-bar-success" style="width: 1%"></div>
                            <p class="text-center" data-fr-bind="currentRecord searchData">Compiling <?php echo $fullname; ?>'s report.</p>
                        </div>
