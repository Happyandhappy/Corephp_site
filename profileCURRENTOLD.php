...
if (!App::Auth()->is_User())
      Url::redirect('http://speedyhunt.com/checkout/index.php?unique=__'.$uniqueidentifierperson.'');
 if (!Membership::is_valid([1]))
      Url::redirect('http://speedyhunt.com/membership.php');
error_reporting(0);
$uniqueidentifierperson = $_GET['unique'];
		...
		<div class="container">
			<div class="row">
				...
				<div class="pg-list-1-left"><div class="col-md-3" id="mobileicon" style="width:100px; margin-right:20px;"> <img src="images/usericon.png" alt="" width="100px;" /> </div> <a href="#"><h3><?php echo $fullname; ?></h3></a>
					<div class="list-rat-ch"> <span><?php echo $dateOfBirth; ?></span>  </div>
				...
				<div class="pg-list-1-right">
					<div class="list-enqu-btn pg-list-1-right-p1">
						<ul>
                          ...
                          <li><div class="input-field col s12"><i class="waves-effect waves-light btn-large full-btn waves-input-wrapper" style=""><input type="submit" name="Update" id="update" value="Update" class="waves-button-input"></i></div></li>
						</ul>
					</div>
				</div>
			</div>
...
<?php if ($SexTest == 'true') {
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								<div class="list-pg-upro">
                                   ...
                                   <li><div class="input-field col s12"><i class="waves-effect waves-light btn-large full-btn waves-input-wrapper" style=""><input type="submit" name="Update" id="update2" value="Update" class="waves-button-input"></i></div></li>
  ...
  e.preventDefault();
  var userid = '<?php echo App::Auth()->fname; ?>'
  var profiletype = 'i';
  var profileid = '<?php echo $uniqueidentifierperson; ?>'
 
  
  var dataString = 'userid='+userid+'&profiletype='+profiletype+'&profileid='+profileid;
  $.ajax({
    type:'POST',
    data:dataString,
    url:'update_profile.php',
    success:function(data) {
      alert('We are going to update this profile for you, and do a manual review. We are going to send you an email once we are done.');
    }
  });
});
</script>
