...
header('Location: https://speedyhunt.com/profile.php?unique='.$uniqueidentifierperson.'');
exit;
}
class verifyPage {
...
<head>
	    ...
	    <title><?php echo 'Search results for '.$fullname.''; ?></title>
...
<body class="hide" data-next-page="membership.php">
...
<ul class="collapsible" data-collapsible="accordion" style="margin-top:0px !important;">
        ...
        <div id="sub-container">
            ...
            <div class="headline hidden-xs" data-fr-bind="currentRecord searchData" style="margin-top:0px !important;">Building Report: <?php echo $fullname;?></div>
                                            ...
                                            <div class="modal-body" data-fr-bind="currentRecord searchData">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 modal-padding">
                                                        ...
                                                        <p>This search may reveal interesting information on <strong><?php echo $fullname;?></strong> such as unseen photos, videos, family, friends, professional connections and more.</p>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mobile-heading">
                                                        ...
                                                        <p data-fr-bind="currentRecord searchData">
                                                            ...
                                                            We've located the following possible relatives of <?php echo $fullname;?> who we have further information about. Please select those you'd like to learn more information about.

                                                        </p>

                                                    </div>

                                                    <form id="form-horizontal" class="col-sm-10 col-sm-offset-1" style="padding:25px;">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="subtitle" data-fr-bind="currentRecord searchData">
                                                              ...
                                                              <?php echo $fullname;?>'s Phone Report May Contain Comments Provided By Users</span>
                                                            ...
                                                            <p>
                                                                ...
                                                                <label for="fcraCheckbox">
                                                                    ...
                                                                    <span>
                                                                         ...
                                                                         I understand that I may see unfiltered comments on <?php echo $fullname;?>'s phone report
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row icon-row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <p data-fr-bind="currentRecord searchData"> Success! Your background report on <?php echo $fullname;?> is available.</p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8 left-column">
                                                            ...
                                                            <div class="lead-part">
                                                                ...
                                                                <form id="signup-modal-form" method="post" data-fr-bind="leadData" data-fr-store="leadData">
                                                                    ...
                                                                    <fieldset class="form-input-group">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                ...
                                                                                <input name="fname" value="{{account[first_name]}}" id="lead_first_name" type="text" class="form-control" placeholder="First Name" required>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                ...
                                                                                <input name="lname" value="{{account[last_name]}}" id="lead_last_name" type="text" class="form-control" placeholder="Last Name" required>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                ...
                                                                                <input name="email" value="{{user[email]}}" id="lead_email" type="email" class="form-control" placeholder="Email Address" required>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12 col-md-9">
                                                                                ...
                                                                                <input name="password" value="{{user[email]}}" id="lead_password" type="password" class="form-control" placeholder="Password" required>
                                                                        ...
                                                                        <!-- <div class="row">
                                                                            ...
                                                                            <div class="wojo right labeled input">
                                                                                ...
                                                                                <input name="captcha" placeholder="Captcha" type="text" class="form-control">
                                                                            ...
                                                                            <div class="wojo basic label">

                                                                                <img src="https://speedyhunt.com/dashboard/captcha.php" alt="" style="height:25px"></div>
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <div class="">
                                                                            ...
                                                                            <button type="submit" class="main-btn main-btn-large btn-block" id="ajaxbtn" data-action="register"><span class="hidden-xs"> Access &amp; </span>Continue</button>
                                                                ...
                                                                <form class="form-horizontal" action="https://www.speedyhunt.com/login.php" data-fr-bind="currentRecord" method="get" target="_blank">

                                                                    <fieldset>

                                                                        <input id="record_search_person_id" name="record_search[person_id]" type="hidden" value="{{bvid}}">
                                                                ...
                                                                <div class="why-icons">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8 fix">
                                                                            ...
                                                                            <div class="why-subheaders">Reviews</div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8 fix">
                                                                            ...
                                                                            <div class="why-subheaders">Track Record</div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <p data-fr-bind="currentRecord searchData">
                                                            ...
                                                            Don't be "left in the dark." SpeedyHunt can notify you whenever there are changes or updates to <?php echo $fullname;?>'s report. People are frequently moving, committing crimes, creating new social media profiles and changing their phone numbers. You could miss
                        ...
                        <div id="crt-acct-warn" class="ext-mod hidden">
                            ...
                            <div class="crc-acct-load-body">
                                ...
                                <button id="crt-acct-warn-confirm" class="main-btn btn btn-md btn-block large-modal-btn">
                                   ...
                                   <span id="crt-acct-warn-message" style="color:#fff !important;"> YES, I UNDERSTAND</span>
...
<!--<script type="text/javascript" src="https://speedyhunt.com/dashboard/view/front/js/masterFlow.js"></script> 
...
// ]]>
    ...
    <script type="text/javascript" src="animtest/animtest/js/bundle.js"></script>

<script src="https://code.jquery.com/jquery-2.1.1.min.js"></script>

<script type="text/javascript" src="animtest/animtest/js/forajax.js"></script>
